...
for i in range(10):
    ...
    # Use ASReviewComplete instead of ASReviewWithArtifacts
    asreview = ASReviewComplete(
        config=config,
        output_dir=f"INT/{topic}/{topic}_complete_run_{n}"
    )
    ...
    # This now runs Phases 1, 2, AND 3!
    ...
    print("\n" + "="*70)
    print("COMPLETE SCREENING RESULTS!")
    print("="*70)
