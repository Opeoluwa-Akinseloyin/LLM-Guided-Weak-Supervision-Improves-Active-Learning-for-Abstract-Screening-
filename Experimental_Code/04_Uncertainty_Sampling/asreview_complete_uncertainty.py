...
Usage:
    Instead of: from asreview_with_artifacts_uncertainty import ASReviewWithArtifacts
...
from asreview_with_artifacts_uncertainty import ASReviewWithArtifacts, SAFEConfig
