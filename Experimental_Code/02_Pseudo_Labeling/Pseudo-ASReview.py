...
- Phase 2: Active learning with stopping criteria (with FIXED classifier metrics)
...
def run_single_review(data_path: str, scores_path: str, output_dir: str,
                      ...
                      random_state: int = 1):
    """Run complete LLM pseudo-labeling with Phase 3"""
    ...
    # 3. Initialize with COMPLETE version
    ...
    # 4. Run complete screening (Phases 1, 2, AND 3)
    ...
    print(f"\n📊 PHASE 2: Active Learning (with stopping)")
    ...
    # Phase 2 classifier metrics (NOW FIXED!)
...
if __name__ == "__main__":
    print("="*70)
    print("Pseudo-ASReview Complete Screening Example")
    print("="*70)
    print()
    ...
    for run in range(1, 11):
        ...
        OUTPUT_DIR = f"results/certainty/INT/CD011768/complete_run_{run}/"
